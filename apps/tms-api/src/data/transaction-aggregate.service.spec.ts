...
describe('TransactionAggregateService', () => {
  ...
  beforeEach(async () => {
    ...
    // Create a mock for TransactionQueueService
    mockTransactionQueueService = {
      notifyTransactionCreated: jest.fn().mockResolvedValue([]),
    };
  ...
  describe('createTransaction', () => {
    it('should create a transaction, set processed_at, and notify transaction queue', async () => {
      ...
      expect(mockTransactionQueueService.notifyTransactionCreated).toHaveBeenCalled();
    });
    ...
    it('should throw ConflictException when transaction with same external_id exists', async () => {
      ...
      expect(mockTransactionRepository.save).toHaveBeenCalled();
      expect(mockTransactionQueueService.notifyTransactionCreated).not.toHaveBeenCalled();
    });
