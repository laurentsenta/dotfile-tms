...
export class TransactionAggregateService {
  ...
  async createTransaction(
    ...
    try {
      ...
      // Later: 2-step commit to avoid losing transactions here. Or have a periodic eval for "old & unprocessed" transactions
      await this.txQueueService.notifyTransactionCreated(savedTransaction);
